...
export async function generateMetadata() {
  return generateMeta({
    title: "Profile & Sports Settings",
    description:
      "Manage your sports profile, notification preferences, and account settings for JUNTO sports coordination.",
    ...
    <>
      <div className="mb-6 space-y-0.5">
        ...
        <p className="text-muted-foreground">
          Manage your sports profile, notifications, and account preferences.
        </p>
      </div>
